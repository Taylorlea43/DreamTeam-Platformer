...
public class MenuScreen extends Screen {
	...
	public void initialize() { 
		playGame = new SpriteFont("PLAY GAME", Config.GAME_WINDOW_WIDTH / 2 - 105, 150, "Comic Sans", 30, new Color(49, 207, 240));
		playGame.setOutlineColor(Color.black);
		playGame.setOutlineThickness(3);
		
		instructions = new SpriteFont("INSTRUCTIONS", Config.GAME_WINDOW_WIDTH / 2 - 105, 200, "Comic Sans", 30, new Color(49, 207, 240));
		instructions.setOutlineColor(Color.black);
		instructions.setOutlineThickness(3);
		
		avatar = new SpriteFont("CHOOSE AVATAR", Config.GAME_WINDOW_WIDTH / 2 - 105, 250, "Comic Sans", 30, new Color(49, 207, 240));
		avatar.setOutlineColor(Color.black);
		avatar.setOutlineThickness(3);
		
		credits = new SpriteFont("CREDITS", Config.GAME_WINDOW_WIDTH / 2 - 105, 300, "Comic Sans", 30, new Color(49, 207, 240));
		credits.setOutlineColor(Color.black);
		credits.setOutlineThickness(3);
		
		quit = new SpriteFont("QUIT", Config.GAME_WINDOW_WIDTH / 2 - 105, 350, "Comic Sans", 30, new Color(49, 207, 240));
