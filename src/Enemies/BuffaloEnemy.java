...
public class BuffaloEnemy extends Enemy {
	...
	public BuffaloEnemy(Point location, Direction facingDirection) {
	        super(location.x, location.y, new SpriteSheet(ImageLoader.load("BuffaloEnemy.png"), 32 , 28), "WALK_LEFT");
