...
public class ZookeeperEnemy extends Enemy {
	...
	public ZookeeperEnemy(Point location, Direction facingDirection) {
		super(location.x, location.y, new SpriteSheet(ImageLoader.load("ZookeeperEnemy.png"), 27, 58), "WALK_LEFT");
