...
public class ScorpionEnemy extends Enemy {
    ...
    public ScorpionEnemy(Point location, Direction facingDirection) {
        super(location.x, location.y, new SpriteSheet(ImageLoader.load("ScorpionEnemy.png"), 23 , 15), "WALK_LEFT");
